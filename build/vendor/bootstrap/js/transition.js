...
+function (n) {
  ...
  function t() {
    ...
    var i = !1,
        r = this;n(this).one("bsTransitionEnd", function () {
      i = !0;
    });var e = function e() {
      i || n(r).trigger(n.support.transition.end);
    };return setTimeout(e, t), this;
  }, n(function () {
    n.support.transition = t(), n.support.transition && (n.event.special.bsTransitionEnd = { bindType: n.support.transition.end, delegateType: n.support.transition.end, handle: function handle(t) {
